...
int main()
{
    ...
    switch(menu) {
        ...
        do {
            ...
            cin>>b;
            if (a >= b) {
                cout<<"Начало диапазона больше начала, начало сейчас "<<a<<"\n";
            }
            if (b<=0) {
                cout<<"Число должно быть больше либо равным 0\n";
            }
        ...
        case 4:
            ...
            cout<<"Количество чисел с тремя различными простыми делителями в диапазоне = "<<count<<". Минимальное из них: "<<min<<"\n";
            break;
        default:
